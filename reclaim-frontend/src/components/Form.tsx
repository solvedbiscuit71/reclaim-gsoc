...
function Form(props: Props) {
    return (
        ...
        <Button onClick={_ => console.log(`Selected ${props.organiser}`)} fontFamily={'Inter, sans-serif'} fontWeight='medium' bgColor='hsl(214 82% 50%)' borderRadius='4px' color='whiteAlpha.900' px='32px' py='18px' _hover={{ bg: 'hsl(214 82% 48%)' }}>Submit</Button>
        </form>
)
}
